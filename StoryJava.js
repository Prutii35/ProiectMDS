const array = [
    ...
    },
    {
        ...
        p2 :"To get to Site 4, he needed to descend into the cave. The laptop beeped and interrupted Aerav’s thoughts. He attached the plan and got the approval to proceed almost immediately, there was no other choice. The closet was, coincidentally, wide open and the battle-suit was gleaming with its vibrant purple colours. Next to it, his plasma rifle sat sleeping, for now. They would both become sated with alien blood, he thought. Or maybe his blood? Aerav got dressed, grabbed the gun and went outside. The warmth disappeared too, along with all other living things in the area. All around, silence and cold reigned, transforming the whole scene into an eerie painting, lifeless on a piece of dry cloth. Aerav walked to the entrance of the cave system. He believed in no God, and even if he did, what use would it be? No thing in the universe would help him down there…",
        url :"images/run.gif",
        url2 : "",
        background :""
    }
...
function changePage(param){
    ...
    document.getElementsByClassName("gif")[0].src = array[param].url;
    if(array[param].url2 != ""){
        document.getElementsByClassName("gif2")[0].src = array[param].url2;
        document.getElementsByClassName("gif2")[0].style.display = "inline-block";
    }
    else{
        document.getElementsByClassName("gif2")[0].style.display = "none";
    }
}
